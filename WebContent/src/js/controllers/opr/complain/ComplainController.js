...
app.controller('complainController',['$rootScope','$scope','$state','$timeout','$http','sessionStorageService','previewService',function($rootScope,$scope,$state,$timeout,$http,sessionStorageService,previewService){
	 ...
	 */
	$scope.session = {};
	$scope.session.cacheArray = ["complainDataTableProperties","complainIdForEdit","complainIdForDetails"];
	 ...
	 */
	$scope.state = {
			list:"app.complain.list",
			add:"app.complain.add",
			edit:"app.complain.edit",
			details:"app.complain.details"
	}
