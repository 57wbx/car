...
app.controller('updateVersionController',['$rootScope','$scope','$state','$timeout','$http',function($rootScope,$scope,$state,$timeout,$http){
...
//		hiddenButton.trigger("click");
	...
	$scope.addRow = function(){
		$state.go("app.updateversion.add");
	}
	...
	$scope.seeDetails = function(id){
		...
		$state.go("app.updateversion.details");
	}
	...
	$scope.editRow = function(){
		...
		$state.go("app.updateversion.edit");
	}
