...
app.controller('RoleController', ['$rootScope','$scope','$state','$timeout','roleBtnService',function($rootScope, $scope, $state, $timeout,roleBtnService) {
	
	var roleBtnUiClass = "app.role.";//用于后台查找按钮权限
